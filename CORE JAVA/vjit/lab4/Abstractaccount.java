...
abstract class account1 extends person {
  ...
  public class Abstractaccount extends account1
	{
		public void withdraw(double wamount )
		{  
	...
	public static void main(String[] args) {
		...
		Abstractaccount a2=new Abstractaccount();
		a2.setName(name1);
		a2.setBalance(amount1);
		a2.setAge(age1);
		a2.setAccno(a1.getAccno());
